...
namespace UnityEngine.PostProcessing
{
    ...
    public sealed class AmbientOcclusionComponent : PostProcessingComponentCommandBuffer<AmbientOcclusionModel>
    {
        ...
        public override void PopulateCommandBuffer(CommandBuffer cb)
        {
            ...
            // Material setup
            Material blitMaterial = this.context.materialFactory.Get(k_BlitShaderString);
            ...
            // AO estimation
            cb.Blit(null, rtMask, material, (int)this.occlusionSource);
            ...
            {
                RenderTextureFormat fbFormat = this.context.isHdr ? RenderTextureFormat.DefaultHDR : RenderTextureFormat.Default;
