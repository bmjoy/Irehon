    ...
    public sealed class MotionBlurComponent : PostProcessingComponentCommandBuffer<MotionBlurModel>
    {
        ...
        public class FrameBlendingFilter
        {
            ...
            public void BlendFrames(CommandBuffer cb, float strength, RenderTargetIdentifier source, RenderTargetIdentifier destination, Material material)
            {
                ...
                Frame f1 = this.GetFrameRelative(-1);
                Frame f2 = this.GetFrameRelative(-2);
                Frame f3 = this.GetFrameRelative(-3);
                Frame f4 = this.GetFrameRelative(-4);
        ...
        public override void PopulateCommandBuffer(CommandBuffer cb)
        {
            ...
            Material blitMaterial = this.context.materialFactory.Get("Hidden/Post FX/Blit");
            Settings settings = this.model.settings;
