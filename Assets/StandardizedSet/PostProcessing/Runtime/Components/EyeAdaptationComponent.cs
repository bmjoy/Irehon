namespace UnityEngine.PostProcessing
{
    public sealed class EyeAdaptationComponent : PostProcessingComponentRenderTexture<EyeAdaptationModel>
    {
        ...
        {
            foreach (RenderTexture rt in this.m_AutoExposurePool)
            {
        ...
        public Texture Prepare(RenderTexture source, Material uberMaterial)
        {
            ...
            Vector4 scaleOffsetRes = this.GetHistogramScaleOffsetRes();

            RenderTexture rt = this.context.renderTextureFactory.Get((int)scaleOffsetRes.z, (int)scaleOffsetRes.w, 0, source.format);
            ...
            else
            {
                ...
                RenderTexture src = this.m_AutoExposurePool[++pp % 2];
                RenderTexture dst = this.m_AutoExposurePool[++pp % 2];
        ...
        public void OnGUI()
        {
            ...
            Rect rect = new Rect(this.context.viewport.x * Screen.width + 8f, 8f, this.m_DebugHistogram.width, this.m_DebugHistogram.height);
