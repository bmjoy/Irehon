namespace UnityEngine.PostProcessing
{
    ...
    public sealed class DepthOfFieldComponent : PostProcessingComponentRenderTexture<DepthOfFieldModel>
    {
        ...
        public void Prepare(RenderTexture source, Material uberMaterial, bool antialiasCoC, Vector2 taaJitter, float taaBlending)
        {
            ...
            RenderTextureFormat cocFormat = this.SelectFormat(RenderTextureFormat.R8, RenderTextureFormat.RHalf);
            ...
            // Material setup
            float f = this.CalculateFocalLength();
            ...
            float maxCoC = this.CalculateMaxCoCRadius(source.height);
            ...
            RenderTexture rtCoC = this.context.renderTextureFactory.Get(this.context.width, this.context.height, 0, cocFormat, RenderTextureReadWrite.Linear);
            ...
            if (antialiasCoC)
            {
                ...
                float blend = this.CheckHistory(this.context.width, this.context.height) ? taaBlending : 0f;
                material.SetVector(Uniforms._TaaParams, new Vector3(taaJitter.x, taaJitter.y, blend));

                RenderTexture rtFiltered = RenderTexture.GetTemporary(this.context.width, this.context.height, 0, cocFormat);
            ...
            RenderTexture rt1 = this.context.renderTextureFactory.Get(this.context.width / 2, this.context.height / 2, 0, colorFormat);
            material.SetTexture(Uniforms._CoCTex, rtCoC);
            Graphics.Blit(source, rt1, material, 2);

            // Bokeh simulation pass
            RenderTexture rt2 = this.context.renderTextureFactory.Get(this.context.width / 2, this.context.height / 2, 0, colorFormat);
