    ...
    public class GTerrainGroupInspector : Editor
    {
        ...
        private void DrawGeometryOverrideGUI()
        {
            ...
            GEditorCommon.Foldout(label, false, id, () =>
            {
                ...
                EditorGUILayout.BeginHorizontal();
                g.OverridePolygonDistribution = EditorGUILayout.Toggle(g.OverridePolygonDistribution, GUILayout.Width(TOGGLE_WIDTH));
                g.PolygonDistribution = (GPolygonDistributionMode)EditorGUILayout.EnumPopup("Polygon Distribution", g.PolygonDistribution);
                EditorGUILayout.EndHorizontal();
