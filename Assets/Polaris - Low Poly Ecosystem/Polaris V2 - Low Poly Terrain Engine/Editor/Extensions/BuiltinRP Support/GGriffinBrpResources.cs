    ...
    public class GGriffinBrpResources : ScriptableObject
    {
        ...
        public static GGriffinBrpResources Instance
        {
            get
            {
                if (instance == null)
                {
                    //instance = AssetDatabase.LoadAssetAtPath<GGriffinBrpResources>("Assets/Polaris - Low Poly Ecosystem/Polaris V2 - Low Poly Terrain Engine/Editor/Data/GriffinBrpResources.asset");
