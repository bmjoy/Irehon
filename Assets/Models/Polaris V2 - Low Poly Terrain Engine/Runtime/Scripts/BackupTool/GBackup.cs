    ...
    public static class GBackup
    {
        ...
        private static void RestoreAlbedoMap(GStylizedTerrain t, string backupName)
        {
                ...
                albedoAData != null)
            {
                ...
                bool willRegenerateGeometry = false;
                string ppName = t.TerrainData.Geometry.PolygonProcessorName;
                if (ppName != null)
                {
                    if (ppName.Equals(typeof(GAlbedoToVertexColorPolygonProcessor).FullName) ||
                        ppName.Equals(typeof(GAlbedoToSharpVertexColorPolygonProcessor).FullName))
                    {
