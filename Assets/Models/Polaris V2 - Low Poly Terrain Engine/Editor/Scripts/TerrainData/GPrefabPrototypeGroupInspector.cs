    ...
    public class GPrefabPrototypeGroupInspector : Editor
    {
        ...
        public static void FixMissingRockPrefab()
        {
            ...
            if (o is GPrefabPrototypeGroup)
            {
                string[] prefabAssetPaths = new string[]
                {
                    "Assets/Griffin - PolarisV2/_Demo/Prefabs/Rock.prefab",
                    "Assets/Griffin - PolarisV2/_Demo/Prefabs/Rock1.prefab",
                    "Assets/Griffin - PolarisV2/_Demo/Prefabs/Rock2.prefab",
                    "Assets/Griffin - PolarisV2/_Demo/Prefabs/Rock3.prefab"
                };
