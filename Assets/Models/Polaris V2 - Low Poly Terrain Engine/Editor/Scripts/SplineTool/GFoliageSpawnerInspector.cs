...
namespace Pinwheel.Griffin.SplineTool
{
    ...
    public class GFoliageSpawnerInspector : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            instance.SpawnTrees = EditorGUILayout.Toggle("Spawn Trees", instance.SpawnTrees);
            if (instance.SpawnTrees)
            {
                ...
                instance.TreeDensity = EditorGUILayout.IntField("Density", instance.TreeDensity);
                EditorGUI.indentLevel -= 1;
            }

            instance.SpawnGrasses = EditorGUILayout.Toggle("Spawn Grasses", instance.SpawnGrasses);
            if (instance.SpawnGrasses)
            {
                ...
                instance.GrassDensity = EditorGUILayout.IntField("Density", instance.GrassDensity);
                EditorGUI.indentLevel -= 1;
            }
