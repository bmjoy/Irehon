...
namespace Pinwheel.Griffin.BillboardTool
{
    public class GBillboardEditor : GTwoPaneWindowWindow
    {
        ...
        private void LoadPrefs()
        {
            ...
            //string atlasMaterialAssetPath = EditorPrefs.GetString(GEditorCommon.GetProjectRelatedEditorPrefsKey(KEY_BILLBOARDEDITOR, KEY_ATLAS_MAT), string.Empty);
            //atlasMaterial = AssetDatabase.LoadAssetAtPath<Material>(atlasMaterialAssetPath);
            //if (atlasMaterial == null)
            //    atlasMaterial = GGriffinSettings.Instance.BillboardToolSettings.AtlasMaterial;

            //string normalMaterialAssetPath = EditorPrefs.GetString(GEditorCommon.GetProjectRelatedEditorPrefsKey(KEY_BILLBOARDEDITOR, KEY_NORMAL_MAT), string.Empty);
            //normalMaterial = AssetDatabase.LoadAssetAtPath<Material>(normalMaterialAssetPath);
            //if (normalMaterial == null)
            //    normalMaterial = GGriffinSettings.Instance.BillboardToolSettings.NormalMaterial;
