    ...
    public class GFoliageStamperInspector : Editor
    {
        ...
        private void DrawActionGUI()
        {
            ...
            GEditorCommon.Foldout(label, true, id, () =>
            {
                ...
                EditorGUILayout.BeginHorizontal();
                if (GUILayout.Button("Clear Trees", GUILayout.Height(EditorGUIUtility.singleLineHeight)))
                {
                    CreateInitialBackup();
                    instance.ClearTrees();
                ...
                if (GUILayout.Button("Clear Grasses", GUILayout.Height(EditorGUIUtility.singleLineHeight)))
                {
                    CreateInitialBackup();
