...
#pragma warning restore 0649
        ...
        private void StartIntensityTween(float target, float duration)
        {
            ...
            {
                FloatTween colorTween = new FloatTween { duration = duration, startFloat = this.m_Light.intensity, targetFloat = target };
                colorTween.AddOnChangedCallback(this.SetIntensity);
