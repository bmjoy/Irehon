    ...
    public class Test_UIProgressBar : MonoBehaviour
    {
        ...
        protected void SetFillAmount(float amount)
        {
            ...
            if (this.m_Text != null)
            {
                ...
                {
                    this.m_Text.text = (this.m_TextValue * amount).ToString(this.m_TextValueFormat);
                }
                else if (this.m_TextVariant == TextVariant.ValueMax)
                {
                    this.m_Text.text = (this.m_TextValue * amount).ToString(this.m_TextValueFormat) + "/" + this.m_TextValue;
                }
            }
        }
