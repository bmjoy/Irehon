...
namespace DuloGames.UI
{
    ...
    public struct ColorBlockExtended
    {
        ...
        {
            get => this.m_ActiveColor;
            set => this.m_ActiveColor = value;
        }

        public Color activeHighlightedColor
        {
            get => this.m_ActiveHighlightedColor;
            set => this.m_ActiveHighlightedColor = value;
        }

        public Color activePressedColor
        {
            get => this.m_ActivePressedColor;
            set => this.m_ActivePressedColor = value;
        }
