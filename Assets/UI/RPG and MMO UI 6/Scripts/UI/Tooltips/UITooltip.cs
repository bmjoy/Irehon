...
#pragma warning restore 0649
        ...
        public float alpha => (this.m_CanvasGroup != null) ? this.m_CanvasGroup.alpha : 1f;

        /// <summary>
        /// Gets the the visual state of the tooltip.
        /// </summary>
        /// <value>The state of the visual.</value>
        public VisualState visualState => this.m_VisualState;
        ...
        public void StartAlphaTween(float targetAlpha, float duration)
        {
            ...
            floatTween.AddOnChangedCallback(this.SetAlpha);
