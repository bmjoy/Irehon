...
#pragma warning restore 0649
        ...
        private void Start()
        {
            ...
            {
                this.m_ButtonPrev.onClick.AddListener(this.OnPrevClick);
            }

            if (this.m_ButtonNext != null)
            {
                this.m_ButtonNext.onClick.AddListener(this.OnNextClick);
            }
        ...
        private void UpdatePagesVisibility()
        {
            ...
            if (this.m_PagesContainer.childCount > 0)
            {
                for (int i = 0; i < this.m_PagesContainer.childCount; i++)
                {
                    this.m_PagesContainer.GetChild(i).gameObject.SetActive((i == this.activePage) ? true : false);
                }
            }
