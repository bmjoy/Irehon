...
#pragma warning restore 0649
        ...
        protected virtual void OnValidate()
        {
            ...
            if (this.m_StepsCount < 1)
            {
                this.m_StepsCount = 1;
            }

            if (this.m_CurrentStep > this.m_StepsCount)
            {
                this.m_CurrentStep = this.m_StepsCount + 1;
            }
        ...
        {
            return ((1f / (this.m_StepsCount + 1)) * step);
        }
        ...
        public void UpdateGridProperties()
        {
            ...
            // Grid spacing
            float spacingX = Mathf.Floor((this.m_StepsGridRect.rect.width - this.m_StepsGridPadding.horizontal - (seps * this.m_SeparatorSize.x)) / (seps - 1) / 2f) * 2f;
