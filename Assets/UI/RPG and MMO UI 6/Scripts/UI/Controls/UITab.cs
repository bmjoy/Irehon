...
#pragma warning restore 0649
        ...
        {
            get => this.m_ImageAnimationTriggers;
        ...
        protected override void OnEnable()
        {
            ...
            this.onValueChanged.AddListener(this.OnToggleStateChanged);
        ...
        protected override void OnDisable()
        {
            ...
            this.onValueChanged.RemoveListener(this.OnToggleStateChanged);
        }
        ...
        public void EvaluateAndToggleContent()
        {
            ...
            {
                this.m_TargetContent.SetActive(this.isOn);
            }
        }
                ...
                foreach (Transform child in this.graphic.transform)
                {
                    ...
                    if (g != null)
                    {
                        if (!g.canvasRenderer.GetAlpha().Equals(targetAlpha))
                        {
                            ...
                            {
                                g.CrossFadeAlpha(targetAlpha, 0.1f, true);
                            }
                        }
                    }
                }
            ...
            if (this.gameObject.activeInHierarchy)
            {
                ...
                switch (this.m_ImageTransition)
                {
                    case Selectable.Transition.ColorTint:
                        this.StartColorTween(this.m_ImageTarget, newImageColor * this.m_ImageColors.colorMultiplier, (instant ? 0f : this.m_ImageColors.fadeDuration));
                        break;
        ...
        private void StartColorTweenText(Color targetColor, float duration)
        {
            ...
            {
                ColorTween colorTween = new ColorTween { duration = duration, startColor = this.m_TextTarget.color, targetColor = targetColor };
