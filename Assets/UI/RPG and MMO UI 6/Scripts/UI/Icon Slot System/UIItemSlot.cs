    ...
    public class UIItemSlot : UISlotBase, IUIItemSlot
    {
        ...
        protected override void OnThrowAwayDenied()
        {
            ...
            if (box != null)
            {
                ...
                box.onConfirm.AddListener(this.Unassign);
                box.Show();
            }
        }
		...
		public static void PrepareTooltip(UIItemInfo itemInfo)
        {
            ...
            if (itemInfo.ItemType == 1)
            {
                ...
                UITooltip.AddLine("(" + (itemInfo.Damage / itemInfo.AttackSpeed).ToString("0.0") + " damage per second)", "ItemAttribute");
            }
            else
            {
