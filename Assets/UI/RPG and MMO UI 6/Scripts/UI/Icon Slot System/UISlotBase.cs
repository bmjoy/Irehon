...
#pragma warning restore 0649
        ...
        {
            get => this.m_DragAndDropEnabled;
            set => this.m_DragAndDropEnabled = value;
        }
        ...
        {
            get => this.m_AllowThrowAway;
            set => this.m_AllowThrowAway = value;
        }
        ...
        {
            get => this.m_DragKeyModifier;
            set => this.m_DragKeyModifier = value;
        }
        ...
        {
            get => this.m_TooltipEnabled;
            set => this.m_TooltipEnabled = value;
        }
        ...
        {
            get => this.m_TooltipDelay;
            set => this.m_TooltipDelay = value;
        }
        ...
        {
            get => this.m_PressTransitionInstaOut;
            set => this.m_PressTransitionInstaOut = value;
        }
        ...
        {
            get => this.m_PressForceHoverNormal;
            set => this.m_PressForceHoverNormal = value;
        }
        ...
        {
            get => this.m_DropPreformed;
            set => this.m_DropPreformed = value;
        }
        ...
        protected virtual void CreateTemporaryIcon(PointerEventData eventData)
        {
            ...
            GameObject iconObj = Instantiate((this.m_CloneTarget == null) ? this.iconGraphic.gameObject : this.m_CloneTarget);
        ...
        {
            RectTransform rt = this.m_CurrentDraggedObject.GetComponent<RectTransform>();
