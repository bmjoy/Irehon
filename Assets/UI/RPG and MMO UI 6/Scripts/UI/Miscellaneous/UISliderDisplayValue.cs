...
#pragma warning restore 0649
        ...
        protected void Awake()
        {
            ...
            {
                this.m_slider = this.gameObject.GetComponent<Slider>();
            }
        }
        ...
        protected void OnEnable()
        {
            if (this.m_slider != null)
            {
                this.m_slider.onValueChanged.AddListener(this.SetValue);
        ...
        protected void OnDisable()
        {
            if (this.m_slider != null)
            {
                this.m_slider.onValueChanged.RemoveListener(this.SetValue);
            }
        }
