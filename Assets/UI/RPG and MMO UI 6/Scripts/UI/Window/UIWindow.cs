...
namespace DuloGames.UI
{
    ...
    public class UIWindow : MonoBehaviour, IEventSystemHandler, ISelectHandler, IPointerDownHandler
    {
        ...
        public static UIWindow FocusedWindow { get => m_FucusedWindow; private set => m_FucusedWindow = value; }
        ...
        public bool IsVisible => (this.m_CanvasGroup != null && this.m_CanvasGroup.alpha > 0f) ? true : false;

        /// <summary>
        /// Gets a value indicating whether this window is open.
        /// </summary>
        /// <value><c>true</c> if this instance is open; otherwise, <c>false</c>.</value>
        public bool IsOpen => (this.m_CurrentVisualState == VisualState.Shown);
        ...
        public bool IsFocused => this.m_IsFocused;
