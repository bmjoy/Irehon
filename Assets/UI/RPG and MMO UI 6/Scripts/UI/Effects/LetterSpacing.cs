...
namespace DuloGames.UI
{
    ...
    public class LetterSpacing : BaseMeshEffect, ILayoutElement
    {
        ...
        private Text text => this.gameObject.GetComponent<Text>();

        public float minWidth => this.text.minWidth;

        public float preferredWidth => ((this.spacing * this.text.fontSize / 100f) * (this.text.text.Length - 1)) + this.text.preferredWidth;

        public float flexibleWidth => this.text.flexibleWidth;

        public float minHeight => this.text.minHeight;

        public float preferredHeight => this.text.preferredHeight;

        public float flexibleHeight => this.text.flexibleHeight;

        public int layoutPriority => this.text.layoutPriority;
        ...
        {
            IList<UILineInfo> lineInfos = this.text.cachedTextGenerator.lines;
        ...
        public void ModifyVertices(List<UIVertex> verts)
        {
            ...
            Vector3 pos;
            float letterOffset = this.spacing * this.text.fontSize / 100f;
