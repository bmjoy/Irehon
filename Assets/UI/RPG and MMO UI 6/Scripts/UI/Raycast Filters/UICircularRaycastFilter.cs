...
namespace DuloGames.UI
{
    ...
    public class UICircularRaycastFilter : MonoBehaviour, ICanvasRaycastFilter
    {
        ...
        {
            get => this.m_RadiusInPercents;
            set => this.m_RadiusInPercents = value;
        }
        ...
        private float rectMaxRadius => Mathf.Sqrt((this.center.x * this.center.x) + (this.center.y * this.center.y));

        /// <summary>
        /// Gets the operational radius.
        /// </summary>
        /// <value>The operational radius.</value>
        public float operationalRadius => (this.m_RadiusInPercents ? (this.rectMaxRadius * (this.m_Radius / 100f)) : this.m_Radius);
